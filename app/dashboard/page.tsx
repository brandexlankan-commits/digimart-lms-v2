...
const translations = {
  ...
  en: {
    ...
    alertCopyStartLinkSuccess: "🔗 Start link copied to clipboard.",
  ...
  ta: {
    ...
    alertCopyStartLinkSuccess: "🔗 Start link copied.",
                      ...
                      <div className="space-y-2 pt-1">
                        {isClassEnded ? (
                          ...
                          <div className="space-y-2">
                            ...
                            {/* Copy Start Link Button */}
                            <button 
                              onClick={() => handleCopyStartLink(item)}
                              className="w-full py-2 bg-emerald-950/40 hover:bg-emerald-900/60 border border-emerald-900/50 text-emerald-400 rounded-xl text-[10px] font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                            >
